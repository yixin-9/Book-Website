...
<body>
	...
	<form name="myform" method="GET" action="SearchResult.jsp" onsubmit="searchDatabase()">
	      <input type="text" name="searchbook" class="searchBox" placeholder="What book is on your mind?" style=" color: black; width: 300px; height: 35px;margin-left:-50px;  font-size: 100%">  
	    ...
	    <h1>Login </h1>
	   	...
	   	<form class="form" id="loginForm" method="POST" action="Login">
					...
					<button name="loginSubmit" form="loginForm" type="submit"style="color: white; background-color: grey; width: 1200px; height: 38px; font-size: 100%">
					Sign in</button>
				</form> 
			</div>
</body>
